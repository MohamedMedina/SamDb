...
GO
PRINT N'Creating [Lookups].[Customer]...';


GO
CREATE TABLE [Lookups].[Customer] (
...
GO
PRINT N'Creating [Lookups].[FK_WorkFieldId_Customer]...';


GO
ALTER TABLE [Lookups].[Customer] WITH NOCHECK
...
GO
ALTER TABLE [Lookups].[Customer] WITH CHECK CHECK CONSTRAINT [FK_WorkFieldId_Customer];
