...
{
	// Summary:
	// The RequestClassList Class.
	[Serializable]
	public partial class RequestClassList : ApplicationBlocks.Layers.BaseCommonList<RequestClass>
	{
		#region Constructor
		/// <summary>
		/// Constructor To Create a new RequestClass object.
		/// </summary>
		public RequestClassList():base()
		{
		}
		/// <summary>
		/// Constructor To Create a new RequestClass object.
		...
		public RequestClassList(IEnumerable<RequestClass> collection):base(collection)
		{
		}
		/// <summary>
		/// Constructor To Create a new RequestClass object.
		...
		public RequestClassList(int capacity):base(capacity)
		{
		}
		#endregion
	...
	// Summary:
	// The RequestClass Class.
	[Serializable]
	public partial class RequestClass : ApplicationBlocks.Layers.BaseCommon<RequestClass>
	{

		#region Factor Method
		/// <summary>
		/// Factor Method To Create a new RequestClass object.
		/// </summary>
		/// <param name="Id">Initial value of Id.</param>
		/// <param name="name">Initial value of name.</param>
		/// <param name="nameAr">Initial value of nameAr.</param>
		/// <returns>Return New RequestClass Object</returns>
		public static RequestClass CreateRequestClass(
											System.Int32 Id, System.String name, System.String nameAr)
		{
			RequestClass objRequestClass = new RequestClass();
			objRequestClass.Id = Id;
			objRequestClass.name = name;
			objRequestClass.nameAr = nameAr;
			return objRequestClass;
		}
		#endregion

		#region RequestClassList
		/// <summary>
		/// Property RequestClassList Represent Rows Collection of RequestClass.
		/// </summary>
		public RequestClassList RequestClassList
		{
			get
			{
				return (RequestClassList)base.BaseCommonList;
			}
		}
		#endregion
		...
		/// <summary>
		/// Property RequestList Represent FK_RequestClassID_Request Relation
