...
{
	// Summary:
	// The RejectReasonList Class.
	[Serializable]
	public partial class RejectReasonList : ApplicationBlocks.Layers.BaseCommonList<RejectReason>
	{
		#region Constructor
		/// <summary>
		/// Constructor To Create a new RejectReason object.
		/// </summary>
		public RejectReasonList():base()
		{
		}
		/// <summary>
		/// Constructor To Create a new RejectReason object.
		...
		public RejectReasonList(IEnumerable<RejectReason> collection):base(collection)
		{
		}
		/// <summary>
		/// Constructor To Create a new RejectReason object.
		...
		public RejectReasonList(int capacity):base(capacity)
		{
		}
		#endregion
	...
	// Summary:
	// The RejectReason Class.
	[Serializable]
	public partial class RejectReason : ApplicationBlocks.Layers.BaseCommon<RejectReason>
	{

		#region Factor Method
		/// <summary>
		/// Factor Method To Create a new RejectReason object.
		/// </summary>
		/// <param name="Id">Initial value of Id.</param>
		/// <param name="name">Initial value of name.</param>
		/// <param name="nameAr">Initial value of nameAr.</param>
		/// <returns>Return New RejectReason Object</returns>
		public static RejectReason CreateRejectReason(
											System.Int32 Id, System.String name, System.String nameAr)
		{
			RejectReason objRejectReason = new RejectReason();
			objRejectReason.Id = Id;
			objRejectReason.name = name;
			objRejectReason.nameAr = nameAr;
			return objRejectReason;
		}
		#endregion

		#region RejectReasonList
		/// <summary>
		/// Property RejectReasonList Represent Rows Collection of RejectReason.
		/// </summary>
		public RejectReasonList RejectReasonList
		{
			get
			{
				return (RejectReasonList)base.BaseCommonList;
			}
		}
		#endregion
		...
		/// <summary>
		/// Property RequestList Represent FK_RejectionReasonID_Request Relation
