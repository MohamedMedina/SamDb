...
{
	// Summary:
	// The WorkFieldList Class.
	[Serializable]
	public partial class WorkFieldList : ApplicationBlocks.Layers.BaseCommonList<WorkField>
	{
		#region Constructor
		/// <summary>
		/// Constructor To Create a new WorkField object.
		/// </summary>
		public WorkFieldList():base()
		{
		}
		/// <summary>
		/// Constructor To Create a new WorkField object.
		...
		public WorkFieldList(IEnumerable<WorkField> collection):base(collection)
		{
		}
		/// <summary>
		/// Constructor To Create a new WorkField object.
		...
		public WorkFieldList(int capacity):base(capacity)
		{
		}
		#endregion
	...
	// The WorkField Class.
	[Serializable]
	public partial class WorkField : ApplicationBlocks.Layers.BaseCommon<WorkField>
	{

		#region Factor Method
		/// <summary>
		/// Factor Method To Create a new WorkField object.
		/// </summary>
		/// <param name="Id">Initial value of Id.</param>
		/// <param name="name">Initial value of name.</param>
		/// <param name="nameAr">Initial value of nameAr.</param>
		/// <returns>Return New WorkField Object</returns>
		public static WorkField CreateWorkField(
											System.Int32 Id, System.String name, System.String nameAr)
		{
			WorkField objWorkField = new WorkField();
			objWorkField.Id = Id;
			objWorkField.name = name;
			objWorkField.nameAr = nameAr;
			return objWorkField;
		}
		#endregion

		#region WorkFieldList
		/// <summary>
		/// Property WorkFieldList Represent Rows Collection of WorkField.
		/// </summary>
		public WorkFieldList WorkFieldList
		{
			get
			{
				return (WorkFieldList)base.BaseCommonList;
			}
		}
		#endregion
		...
		/// <summary>
		/// Property CustomerList Represent FK_WorkFieldId_Customer Relation
